...
public class haha {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Rata-rata pembelian %s : %.2f",  menu[indexKoreanFood], rataRataKoreanFood);
        ...
        System.out.println("Total pemasukan dalam satu hari: Rp." + (int)totalPemasukan);
